...
import ServiceModal from "../ServiceModal/ServiceModal.tsx";

interface ServiceCardProps {
  variant: ServicesCardsType;
  setOpenCard: React.Dispatch<React.SetStateAction<ServicesCardsType | null>>
  openCard?: ServicesCardsType | null;
}

const ServiceCard: React.FC<ServiceCardProps> = ({ variant, setOpenCard, openCard }) => {
  return (
    <>
      {openCard != undefined && openCard === variant && (<ServiceModal variant={variant} onClose={setOpenCard} />)}
      <div className="serviceCard">
        ...
        <div className="serviceCard-wrapper-down">
          ...
          <button className="serviceCard-button" onClick={() => setOpenCard(variant)}>Подробнее</button>
